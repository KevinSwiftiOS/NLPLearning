...
import  sys;
import  os;
# seq_list = jieba.cut("我来到清华大学",cut_all=True);
# #使用全模式
# print("Full Mode" + "/".join(seq_list));
# #精确模式
# seq_list = jieba.cut("我来到清华大学",cut_all=False);
# print("Default Mode" + "/".join(seq_list));
# #默认精确模式
# seq_list = jieba.cut("他来到了网易杭研大楼")
# #用于将序列化中的对象迭代叠加
# print(",".join(seq_list));
# # 搜索引擎模式
# seq_list = jieba.cut_for_search("小明硕士毕业于中国科学院计算所，后在日本京都大学深造")
# print(",".join(seq_list));
#进行初始分词
#配置utf-8路径
# reload(sys)
...
if __name__ == '__main__':
    ...
    # 对训练集进行分词
    corpus_path = "/Users/hcnucai/Desktop/FuDan/train_corpus/"  # 未分词分类语料库路径
    seg_path = "/Users/hcnucai/Desktop/FuDan/train_corpus_seg/"  # 分词后分类语料库路径
    corpus_segment(corpus_path, seg_path)
    corpus_path = "/Users/hcnucai/Desktop/FuDan/test_corpus/"  # 未分词分类语料库路径
    seg_path = "/Users/hcnucai/Desktop/FuDan/test_corpus_seg/"  # 分词后分类语料库路径
    corpus_segment(corpus_path, seg_path)